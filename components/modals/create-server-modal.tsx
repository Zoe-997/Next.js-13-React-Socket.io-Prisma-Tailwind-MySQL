        ...
        <Dialog open={isModalOpen} onOpenChange={handleClose}>
            <DialogContent className="bg-white text-black p-0 overflow-hidden">
                <DialogHeader className="pt-8 px-6">
                    ...
                    <DialogDescription className="text-center">Give your server a personality with a name and an iamge. You can always chang it later.</DialogDescription>
                </DialogHeader>
                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                        <div className="space-y-8 px-6">
                            ...
                            <FormField control={form.control} name="name" render={({field}) => (
                                <FormItem>
                                    <FormLabel className="uppercase text-ts font-bold text-zinc-500 dark:text-secondary/70">Server name</FormLabel>
                                    <FormControl>
